...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_577b3a1386060bc8b566106a59161fef6b46c786b845f0b59637df4bd2bc4e2b');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '575052dbb1c520.80704489', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('medbbelaid@gmail.com');
        $a->setPassword(119304647);
        $a->setAuthMode(NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '+216 52 544 398');
        $instance->addGlobal('fax', '02 35 00 00 00');
        $instance->addGlobal('adresse', 'rue Farhat Hached Sahline Tunisie');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'medbbelaid@gmail.com',
            'mailer_password' => 119304647,
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'medbbelaid@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 119304647,
